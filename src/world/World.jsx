...
export default function World(props) {
    ...
    const propsTexture = useTexture({
        map: PATH + "coast_sand_01_diff_1k.jpg", // es para la textura
        normalMap: PATH + "coast_sand_01_nor_gl_1k.jpg", // es para la normal
        roughnessMap: PATH + "coast_sand_01_rough_1k.jpg", // es para el brillo
        displacementMap: PATH + "coast_sand_01_rough_1k.jpg", // es para la rugosidad
    });
